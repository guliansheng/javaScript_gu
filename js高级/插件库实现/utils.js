var utils = (function(){
        ...
        //2.只传入一个参数获取所有子元素节点(传入一个元素),传入两个参数获取该元素下的所有目标元素(传入一个元素和目标元素)
        ...
        function prev(curEle){
            if(flag){
                return curEle.previousElementSibling;//ie9以下不支持
            }
        ...
        function Tab(tab,num,ev){
            ...
            var tabFirst = utils.firstChild(tab) ,
                tabFirstChilds = utils.children(tabFirst) ,
            ...
            utils.addClass(tabFirstChilds[num],'select');
            ...
            // for(var i = 0; i < tabFirstChilds.length; i++){
            //     (function(i){
            //         tabFirstChilds[i].index = i;
            //         tabFirstChilds[i][ev] = function(){
            ...
            //             utils.addClass(divList[this.index],'select');
            //         }
            //     })(i)
            // }
        }
